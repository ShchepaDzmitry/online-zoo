import{h as C}from"./headerNavHighlightsUtils-zXgUO7cl.js";import{a as x}from"./handleDataUtils-D8eKRCF6.js";const P=new URLSearchParams(window.location.search),m=P.get("id"),u=[{id:1,imgPath:"../../assets/images/did_you_know_panda.png",videoId:"gnEuhfyZPPQ"},{id:2,imgPath:"../../assets/images/did_you_know_lemur.png",videoId:"2M1BmfHlOEI"},{id:3,imgPath:"../../assets/images/did_you_know_gorilla.png",videoId:"yfSyjwY6zSQ"},{id:5,imgPath:"../../assets/images/did_you_know_eagles.png",videoId:"41eq4VzCYc4"}],L=document.getElementById("didYouKnow"),B=document.getElementById("youtubePreviewContainer"),_=document.getElementById("commonName"),k=document.getElementById("scientificName"),N=document.getElementById("type"),Y=document.getElementById("size"),D=document.getElementById("diet"),K=document.getElementById("habitat"),z=document.getElementById("range"),H=document.getElementById("didYouKnowImgPath"),W=document.getElementById("didYouKnowDescription"),A=e=>{const{size:t,commonName:i,description:n,diet:o,detailedDescription:h,habitat:f,scientificName:v,range:I,type:S,id:b}=e.data,s=u.find(q=>q.id===b);console.log(u,s),Y.textContent=t,D.textContent=o,K.textContent=f,z.textContent=I,k.textContent=v,_.textContent=i,N.textContent=S,W.textContent=h,L.textContent=n,H.src=s.imgPath,w(s.videoId)},w=e=>{console.log(e),B.innerHTML=`
    <iframe 
        width="560"
        height="315"
