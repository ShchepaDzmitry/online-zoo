const animals = [
    {
        ...
        name: "Lucas",
        species: "Giant Panda",
        carouselCardDescription: "Native to central China, giant pandas have come to symbolize vulnerable species.",
        carouselCardImage: "../../assets/images/panda_lucas.png",
        feedCardImgPath: "../../assets/images/lucas_feedcard.png",
        feedCardDescription: "Your $30 could give Lucas a slice of panda cake, made with our secret recipe.",
        cameraTypeHeading: "live panda cams",
    ...
    },
    {
        ...
        carouselCardDescription: "Lemurs are considered the world's most endangered group of mammals.",
        carouselCardImage: "../../assets/images/lemur_andy.png",
