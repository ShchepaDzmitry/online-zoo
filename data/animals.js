const animals = [
    ...
    },
    {
        ...
        zoosPageHeading: "lemurs cams",
        youtubeVideoIds: [{ id: "2M1BmfHlOEI", index: 1 }, { id: "vw2Spqhk4AY", index: 2 }, { id: "iTY2EOKfYZ4", index: 3 }],
    ...
    },
    {
        ...
        makeDonationHeading: "make a difference for the gorillas!",
        makeDonationText: " It is our goal to ensure the conservation and restoration of the gorilla population and their habitat in Central Africa. To do this, we need your help! Bring your food charity straight to Glen and his family.",
        didYouKnowText: "In addition to having distinctive fingerprints like humans do, gorillas also have unique nose prints. Gorillas are the largest of the great apes, but the western lowland gorilla is the smallest of the subspecies.",
        youtubeVideoIds: [{ id: "yfSyjwY6zSQ", index: 1 }, { id: "672cUSe69J0", index: 2 }, { id: "OW2PkfuF8co", index: 3 }],
        zoosPageHeading: "gorilla cams",
    ...
    },
    {
        ...
        youtubeVideoIds: [{ id: "B4-L2nfGcuE?", index: 1 }, { id: "41eq4VzCYc4", index: 2 }, { id: "yPq9aNukckQ", index: 3 }],
        zoosPageHeading: "bald eagle cams",
